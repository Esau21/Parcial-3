...
@section('content')
    <section class="content-header">
        <center>
            <h1 class="text-primary p-5">Generar Promedio de Estudiante</h1>
            ...
            <div class="row">
                <label for="staticEmail" class="col-sm-2 col-form-label"> Pracial: </label>
                <div class="form-group col-sm-6">
            ...
            <div class="row">
                <label for="staticEmail" class="col-sm-2 col-form-label">P.F</label>
                <div class="form-group col-sm-6">
